...
class SubmissionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create submission" do
    assert_difference('Submission.count') do
      post submissions_url, params: { submission: { challenge_id: @submission.challenge_id, submission: @submission.submission } }
    end
  ...
  test "should update submission" do
    patch submission_url(@submission), params: { submission: { challenge_id: @submission.challenge_id, submission: @submission.submission } }
